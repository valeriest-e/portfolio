      ...
      <div className="container">
        <div className="max-w-2xl">
          ...
          <p className="text-muted-foreground mb-10">
            I'm currently looking for junior developer positions in Berlin or remote. 
            If you think we'd be a good fit, I'd love to hear from you.
          </p>
          
          <div className="space-y-4">
            <a 
              href="mailto:hello@valeriia-bilous.dev" 
            ...
            >
              ...
              <span className="font-mono group-hover:text-primary transition-colors">
                hello@valeriia-bilous.dev
              </span>
            </a>
            
            <a 
              href="https://github.com/valeriia-bilous" 
              target="_blank"
            ...
            >
              ...
              <span className="font-mono group-hover:text-primary transition-colors">
                github.com/valeriia-bilous
              </span>
            </a>
            
            <a 
              href="https://linkedin.com/in/valeriia-bilous" 
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 border-2 border-border hover:border-foreground transition-colors group"
            >
